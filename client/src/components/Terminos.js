...
function Terminos() {
    return(
        ...
        <div className="container justify-center">
            ...
            <p>Demiparte es una compañía de tecnología que ofrece servicios vinculados principalmente al marketing digital, a través de recomendaciones retribuidas.
Para poder operar en la plataforma todas las Personas Usuarias deberán aceptar los Términos y Condiciones.
Podrán operar dentro de demiparte quienes tengan capacidad legal y menores de edad debidamente autorizados.
Cada Persona Usuaria es responsable de los datos personales que brinda al momento de registrarse y se obliga a mantenerlos actualizados. Además, es el único responsable del uso y resguardo de su contraseña.</p> 
<h3>1- Términos y Condiciones</h3>
<p>Las Personas Usuarias aceptan estos Términos y Condiciones desde el momento en que se registran en el Sitio.
Cuando debamos hacer cambios importantes en nuestros servicios, publicaremos las modificaciones con 10 días corridos de anticipación para que las Personas Usuarias puedan revisarlas y seguir usando el Sitio. El plazo será de 5 días corridos en caso de que tengamos que actualizar las tarifas de nuestros servicios. En ningún caso afectarán las operaciones que ya hayan finalizado.
Las Personas Usuarias que no tengan obligaciones pendientes con demiparte o con otras Personas Usuarias, podrán finalizar la relación con Mercado Libre cancelando su cuenta.</p> 
<h3>2- Capacidad</h3>
...
Quien use el Sitio en representación de una empresa deberá tener capacidad para contratar a nombre de ella. Además, para poder usar la cuenta, la Persona Usuaria debe encontrarse activa.</p>
...
La cuenta es personal, única e intransferible, es decir que bajo ningún concepto se podrá vender o ceder a otra persona. Se accede a ella con la clave personal de seguridad que haya elegido y que deberá mantener bajo estricta confidencialidad. La Persona Usuaria podrá crear cuentas de colaboración y definir sus permisos de acceso. En cualquier caso, la Persona Usuaria será la única responsable por las operaciones que se realicen en su cuenta. En caso de detectar un uso no autorizado de su cuenta, deberá notificar de forma inmediata y fehaciente a demiparte. 
...
Además, en caso de detectar el uso de más de una cuenta, podremos aplicar retenciones, débitos y/o cualquier otra medida si consideramos que ese accionar puede perjudicar al resto de las personas que usan el Sitio o a demiparte, más allá de las sanciones que pudieran corresponder.</p> 
<h3>4- Privacidad de datos</h3>
<p>En demiparte hacemos un uso responsable de la información personal, protegiendo la privacidad de las Personas Usuarias que nos confiaron sus datos y tomando las medidas necesarias para garantizar la seguridad en nuestro Sitio.

Demiparte puede compartir la información personal a las Empresas (Usuarios) registrados, con el único fin de llevar acabo la función de seguimiento y registro de las actividades de los Usuarios para el correcto funcionamiento del sistema, esto contempla, emisión de recomendaciones y su seguimiento, presentación, confirmación, acumulación de puntos y posterior canje por productos/servicios por parte de las Empresas (Usuarios) registrados, como así también la utilización de dichos datos para promociones y mejoras de servicios.</p>   
